...
*/
- (UIColor * _Nonnull)tintedWithAmount:(CGFloat)amount;
/**
...
*/
- (UIColor * _Nonnull)shadedWithAmount:(CGFloat)amount;
- (UIColor * _Nonnull)mixedLabWithColor:(UIColor * _Nonnull)color weight:(CGFloat)weight;
- (UIColor * _Nonnull)mixedHSLWithColor:(UIColor * _Nonnull)color weight:(CGFloat)weight;
- (UIColor * _Nonnull)mixedHSBWithColor:(UIColor * _Nonnull)color weight:(CGFloat)weight;
- (UIColor * _Nonnull)mixedRGBWithColor:(UIColor * _Nonnull)color weight:(CGFloat)weight;
- (CGFloat)mixedHueWithSource:(CGFloat)source target:(CGFloat)target;
@end
...
*/
- (UIColor * _Nonnull)adjustedHueWithAmount:(CGFloat)amount;
/**
...
/**
  ...
  A lighter DynamicColor.
*/
- (UIColor * _Nonnull)lighterWithAmount:(CGFloat)amount;
/**
  ...
  A darker DynamicColor.
*/
- (UIColor * _Nonnull)darkenedWithAmount:(CGFloat)amount;
/**
...
*/
- (UIColor * _Nonnull)saturatedWithAmount:(CGFloat)amount;
/**
...
*/
- (UIColor * _Nonnull)desaturatedWithAmount:(CGFloat)amount;
/**
...
*/
- (BOOL)isEqualToHexString:(NSString * _Nonnull)hexString;
/**
...
*/
- (CGFloat)contrastRatioWith:(UIColor * _Nonnull)otherColor;
@end
...
*/
- (UIColor * _Nonnull)adjustedAlphaWithAmount:(CGFloat)amount;
@end
